/* ==========================================================
   LÓGICA DO CABEÇALHO E ANIMAÇÕES
   ========================================================== */
  ...
  const bannerPrincipal = document.querySelector('.secao-destaque');
  if (bannerPrincipal) {
    bannerPrincipal.addEventListener('mouseenter', () => bannerPrincipal.classList.add('hover-iluminado'));
    bannerPrincipal.addEventListener('mouseleave', () => bannerPrincipal.classList.remove('hover-iluminado'));
  }
 
  const secaoCategorias = document.querySelector('.secao-categorias');
  if (secaoCategorias) {
    secaoCategorias.addEventListener('mouseenter', () => secaoCategorias.classList.add('hover-iluminado'));
    secaoCategorias.addEventListener('mouseleave', () => secaoCategorias.classList.remove('hover-iluminado'));
  }
  ...
  /* ==========================================================
     ...
     document.addEventListener('DOMContentLoaded', function() {
      ...
      // FUNÇÃO AUXILIAR: EFEITO TREMIDINHA NO BOTÃO E ERRO NO CAMPO
      function dispararErroBotao(botao, camposComErro = []) {
        botao.classList.remove('tremer');
        void botao.offsetWidth; // Força re-renderização para reiniciar a animação
      ...
      // ==========================================================
      // FUNCIONALIDADE 2: VALIDAÇÃO COM TREMIDINHA NO BOTÃO
      // ==========================================================
      ...
      if (formLogin) {
        formLogin.addEventListener('submit', function(e) {
          ...
          // Exemplo de validação: verifica se preencheu
      ...
      if (formCadastro) {
        formCadastro.addEventListener('submit', function(e) {
          ...
          // Verificação de senhas não coincidentes
